...
public class BasicBow extends Item {
    public BasicBow(){
        super(1, 0, 4, 10, "BasicBow", "The Basic Bow. Pull back the string and the arrow goes flying. You know how a bow works.", "", true, ItemSlot.WEAPON, ItemType.SINGLETARGET);
    }
}
